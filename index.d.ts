...
export declare const getAllServerData: (
  options: ICommandObject
) => Promise<IAllData>;
export declare const openConnection: (
  options: ICommandObject
) => Promise<boolean>;
export declare const parseBanListResponseToJs: (res: string) => string[];
export declare const parseStatusResponseToJs: (
  statusString: string
) => StatusResponse;
export declare const parseWhitelistResponseToJs: (res: string) => string[];
export declare const sendRCONCommandToServer: (
  options: ICommandObject,
  timeout?: number
) => Promise<any>;
export declare function tryParseResponse(response: string): TryParseResponse;

export interface INodeMisRCON {
  getAllServerData(options: ICommandObject): Promise<IAllData>;
  openConnection(options: ICommandObject): Promise<boolean>;
  parseBanListResponseToJs(res: string): string[];
  parseStatusResponseToJs(statusString: string): StatusResponse;
  parseWhitelistResponseToJs(res: string): string[];
  sendRCONCommandToServer(
    options: ICommandObject,
    timeout?: number
  ): Promise<any>;
  tryParseResponse(response: string): TryParseResponse;
}

declare const NodeMisRCON: INodeMisRCON;

export default NodeMisRCON;
